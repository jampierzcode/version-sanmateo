  ...
  return (
    <div className="row containerbody2">
      <div className="col-sm-8 d-flex flex-column justify-content-center">
        <h1 className="display-5 font-weight-bold ml-2 pt-0">{titulo1}</h1>
        <p className="h5 ml-2">{text1}</p>
        <h1 className="display-6 font-weight-bold ml-2">{titulo2}</h1>
        <p className="h5 ml-2">{text2}</p>
      </div>
